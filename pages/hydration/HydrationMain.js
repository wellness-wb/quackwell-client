...
const HydrationMain = ({ navigation }) => {
    ...
    <View style={styles.toggleContainer}>
        <GradientButton
            ...
            width={80}
            height={50}
            colors={unit === "L" ? ["#F3CAAF", "#F0A26F"] : ["#153CE6", "#0C2180"]}
        ...
        <GradientButton
            ...
            width={80}
            height={50}
            colors={unit === "fl oz" ? ["#F3CAAF", "#F0A26F"] : ["#153CE6", "#0C2180"]}
        ...
        <GradientButton
            ...
            onPress={() => {
                const goal = parseFloat(hydrationGoal);
                if ((unit === "fl oz" && (goal / 33.814 < 1.5 || goal / 33.814 > 6)) || (unit === "L" && (goal < 1.5 || goal > 6))) {
                    setWarningVisible(true); // Show warning
                    return;
                }
